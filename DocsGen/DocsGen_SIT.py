...
class genSIT:
    ...
    def mostrar_progresso(self):
        ...
        self.janela_progress.title("Gerando SIT...")
    ...
    def _executar_geracao(self):
        try:
            ...
            self.root.after(0, lambda: messagebox.showerror("Erro", f"Erro ao gerar SIT: {str(e)}"))
